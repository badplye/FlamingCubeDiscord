...
public class Ban extends ListenerAdapter {
    ...
    public Ban(OceanusDiscord oceanusDiscord){
    ...
    public void onSlashCommandInteraction(SlashCommandInteractionEvent event) {
        ...
        if (event.getName().equalsIgnoreCase("ban")) {
            ...
            if(!exempt || event.getOption("proof") != null) {
                logChannel.sendMessageEmbeds(Moderation.staffLog(mcPlugin, id, "Ban", "Permanent", target, sender, event.getOption("reason").getAsString(), event.getOption("proof").getAsString()).build()).queue();
            } else {
                logChannel.sendMessageEmbeds(Moderation.staffLog(mcPlugin, id, "Ban", "Permanent", target, sender, event.getOption("reason").getAsString()).build()).queue();
